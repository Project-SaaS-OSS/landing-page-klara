      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-14">
          ...
          <h2
            ...
            style={{ fontSize: "clamp(1.6rem, 3vw, 2.3rem)", fontWeight: 800, lineHeight: 1.2 }}
          >
            Fitur Lengkap untuk Kebutuhan{" "}
            <span className="text-blue-600">Bimbel Modern</span>
          </h2>
          <p className="text-slate-500 leading-relaxed">
            Semua yang dibutuhkan untuk menjalankan operasional lembaga kursus ada di satu tempat.
          </p>
        </div>
          ...
          {features.map((feat) => (
            ...
            >
              ...
              <div className="flex items-center justify-between mb-1">
                <h3 className="text-slate-800 font-semibold" style={{ fontSize: "0.9rem" }}>
                  {feat.title}
                </h3>
              </div>
